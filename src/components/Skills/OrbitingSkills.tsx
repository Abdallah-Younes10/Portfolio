...
// --- Type Definitions ---
type IconType = 'html' | 'css' | 'javascript' | 'react' | 'laravel' | 'tailwind';
 ...
 laravel: {
  component: () => (
    <svg viewBox="0 0 24 24" fill="#FF2D20" className="w-full h-full">
      <path
        d="M23.642 5.431l-3.59-2.073V0L16.463 2.073v4.147l-3.589 2.073V4.147L9.284 2.073V6.22L5.695 8.293V4.147L2.105 2.073v4.147L0 7.44v9.12l7.18 4.147 3.59-2.073 3.589 2.073L24 15.2V6.22l-.358-.789zM17.18 3.307l1.795 1.036-1.795 1.036-1.795-1.036 1.795-1.036zm-7.18 0l1.795 1.036L10 5.379 8.205 4.343 10 3.307zM3.9 5.379l1.795 1.036L3.9 7.451 2.105 6.415 3.9 5.379zm5.384 12.32L1.795 13.36V8.687l7.489 4.339v4.673zm.716-5.91L2.511 7.451 6.41 5.2l7.489 4.339L10 11.789zm3.589 7.154l-2.873-1.661v-4.256l2.873 1.661v4.256zm.358-5.114L6.458 9.49l3.9-2.252 7.489 4.339-3.9 2.252zm8.258.394l-7.489 4.339v-3.875l7.489-4.339v3.875zm0-5.114l-3.642 2.108-3.9-2.252 3.9-2.252 3.642 2.108z"
        fill="#FF2D20"
      />
    </svg>
  ),
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow: `0 0 50px ${colors.primary}, inset 0 0 60px ${colors.secondary}`,
...
export default function OrbitingSkills() {
  ...
  return (
    <main className="w-full flex items-center justify-center overflow-hidden">
      ...
      <div 
        className="relative w-[calc(90vw-0px)] h-[calc(120vw-0px)] md:w-[450px] md:h-[450px] flex items-center justify-center"
