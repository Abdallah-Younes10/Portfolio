...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  const childArr = useMemo(() => Children.toArray(children) as React.ReactElement[], [children]);
  const refs = useMemo(
    ...
    isValidElement(child)
      ? cloneElement(child as React.ReactElement, {
          ...
          onClick: (e: React.MouseEvent<HTMLDivElement>) => {
            const childOnClick = (child.props as { onClick?: (event: React.MouseEvent<HTMLDivElement>) => void }).onClick;
            childOnClick?.(e);
            onCardClick?.(i);
          }
        } as any)
